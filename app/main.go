...
import (
	...
	"github.com/mistermoe/go-starter/app/handlers"
...
func run(log *log.Logger) error {
	...
	cfg.Version.SVN = "2022.02.01"
	cfg.Version.Desc = "derpa skerpa"
	...
	log.Printf("main: Started : Application initializing : version %q", cfg.Version.SVN)
